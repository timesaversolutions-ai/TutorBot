...
export default function CoCreateScreen() {
  ...
  const [chatHistory, setChatHistory] = useState([{ role: 'system', content: "You've selected the Co-Create service. Here, we collaborate to create explanations, scenarios, or projects. What would you like to create together?" }]);
