...
export default function MentorCoachScreen() {
  const [userInput, setUserInput] = useState('');
  const [chatHistory, setChatHistory] = useState([{ role: 'system', content: "You've selected the Mentor/Coach service. I'll guide and provide feedback to help you improve your skills. What would you like to focus on?" }]);
